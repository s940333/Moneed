        ...
        <div class="container clearfix"> 
            ...
            <div id="sidebar" class="aside"> 
                ...
                <li><a href="home.php"><span class="menu-number">00</span> 回到首頁 <span class="menu-desc">Homepage</span></a></li>
                    <li><a href="http://s940333.lionfree.net/granth_fund/source/html_source/home.php"><span class="menu-number">01</span> 募款首頁 <span class="menu-desc">Auction Homepage</span></a></li>
...
<td>
  <strong>募款車</strong></td>
          ...
          <td align="left" valign="top">
		    <table width="701" class="order_step03_style6">
                <tr>
				...
				<tr>
                  <td width="191" align="center" valign="middle" bgcolor="#FFFF66" class="order_step03_style8">
                    收件人
                  </td>
                  <td width="479" align="center" valign="middle" bgcolor="#FFFF66" class="order_step03_style9">
                    收件地址
                  </td>
...
<table width="700" class="order_step01_style6">
                ...
                <tr>
                  ...
                  <td width="234" align="center" valign="middle" bgcolor="#FFFF66" class="order_step01_style23">&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td height="26" align="center" valign="middle" class="order_step01_style24">
					  ..
                    </td>
                    <td align="center" valign="middle" class="order_step01_style24">..
				...
				<tr>
                  <td colspan="6" class="order_step03_style22">
				    <span class="order_step03_style23">
                    》請選擇付款方式</span><br />
                    </td>
                </tr>
                    <form name="MyForm1" action="store_cart4.php" method="POST">
					<select name="dept_name" size="1">
<option value="0" selected>線上刷卡 財金資訊公司 - SSL PLUS 網路交易安全付款機制</option>
<option value="1">郵政劃撥 戶名：MONEED份有限公司 劃撥帳號：12345678</option>
<option value="2">電匯付款 帳號：台北三得銀行(代碼111) 南港分行 1111-2222-3333</option>
<option value="3">ATM轉帳 帳號：台北三得銀行(代碼111) 南港分行 2222-3333-4444 </option>
<option value="4">PChomePay支付連 信用卡</option>
</select> <br>
<tr>
                  <td colspan="6" align="right" valign="middle" class="order_step03_style31"><input name="order_nextstep" type="submit" class="order_step03_style32"
                      value="下一步" />		
		          </td>
                </tr>
              </table>
