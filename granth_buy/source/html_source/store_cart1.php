    ...
    <div id="header" class="wrapper">
        <div class="container clearfix">
            ...
            <div id="page-info">
                <div id="page-title">
                    <h1>商品總覽</h1>
                    <span class="title-desc">Commodity Overview</span></div>
...
<table width="701" class="order_step01_style6">
                <tr>
                  <td colspan="5" bgcolor="#FFFF66" class="order_step01_style18"><strong>》臨時購物車</strong></td>
                </tr>
				<tr>
                  
                  <td width="175" align="center" valign="middle" class="order_step01_style20">編號</td>
                  <td width="175" align="center" valign="middle" class="order_step01_style21">名稱</td>
                  <td width="175" align="center" valign="middle" class="order_step01_style22">商品金額</td>
                ...
                <tr>
                 ...
                 <tr>
                  <td colspan="5" bgcolor="#FFFF66" class="order_step01_style18"><strong>》賣家募款對象</strong></td>
                </tr>
				<tr>
                  <td width="175" align="center" valign="middle" class="order_step01_style19">募款機構1</td>
                  <td width="175" align="center" valign="middle" class="order_step01_style20">拍賣所得金額捐款</td>
                  <td width="175" align="center" valign="middle" class="order_step01_style21">募款機構2</td>
                  <td width="175" align="center" valign="middle" class="order_step01_style22"><span class="order_step01_style20">拍賣所得金額捐款</span></td>
