...
#top #sidebar #navigation li a .menu-desc {
	color: #F00;
}
</style>
</head>
...
<div id="sidebar" class="aside"> 
  ...
  <ul id="navigation">
                <li><a href="home.html"><span class="menu-number">00</span> 回到首頁 <span class="menu-desc">Homepage</span></a></li>
                    <li><a href="about.html"><span class="menu-number">01</span> 拍賣首頁 <span class="menu-desc">Auction Homepage</span></a></li>
                  <li><a href="home.html"><span class="menu-number">02</span> 專案總覽 <span class="menu-desc">Project Overview</span></a></li>
      
                    <li class="current parent"><a href="#"><span class="menu-number">03</span> 會員登入 <span class="menu-desc">Member Login</span></a>
                      <ul>
                            <li class="current"><a href="login.html">登入</a></li>
                            <li><a href="newmem.html">註冊</a></li>
                      </ul>                    
                  </li>
...
<form id="form1" name="form1" method="post" action="connect.php">
  ...
  <h5 align="center">如尚未加入會員，<a href="newmember.php">請按此</a></h5>
  <h5 align="center">如忘記帳號密碼，請按此</h5>
  <p align="center">&nbsp;</p>
