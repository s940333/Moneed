          ...
          <td align="left" valign="top">
		    <form action="<?php echo $editFormAction; ?>" method="POST" name="shopper_form" id="shopper_form">
			  <table width="700" class="order_step02_style6">
               ...
               <td width="431" " align="center" valign="middle" bgcolor="#FFFF66" class="order_step02_style9"></td>
                </tr>
                 <tr>
				...
				<tr>
                  <td align="center" valign="middle" class="order_step02_style12"><input name="name" type="text" class="order_step02_style13" value="<?php echo $row[6]; ?>" size="10" /></td>
                  <td align="center" valign="middle" class="order_step02_style12"><input name="address" type="text" class="order_step02_style13" value="<?php echo $row[4]; ?>" size="40" /></td>
...
<table width="700" class="order_step01_style6">
				...
				<tr>
                  <td width="62" align="center" valign="middle" bgcolor="#FFFF66" class="order_step01_style19">X</td>
                  <td width="30" align="center" valign="middle" bgcolor="#FFFF66" class="order_step01_style20">編號</td>
                  <td width="30" align="center" valign="middle" bgcolor="#FFFF66" class="order_step01_style21">名稱</td>
                  <td width="62" align="center" valign="middle" bgcolor="#FFFF66" class="order_step01_style22">募款金額</td>
                  <td width="135" align="center" valign="middle" bgcolor="#FFFF66" class="order_step01_style23">贊助金額</td>
                </tr>
    ...
    <input type="submit" name="nsupport" id="nsupport" value = "確定金額"  />
                ...
                <form action="fundaddlist.php" method="post" name="next_form" id="next_form">
